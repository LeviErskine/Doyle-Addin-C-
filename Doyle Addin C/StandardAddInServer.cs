...
namespace Doyle_Addin
{
    ...
    public class StandardAddInServer : ApplicationAddInServer
    {
        ...
        public void Activate(ApplicationAddInSite addInSiteObject, bool firstTime)
        {
            ...
            Doyle_Addin.GlobalsHelpers.ThisApplication = addInSiteObject.Application;

            // Get a reference to the ControlDefinitions object. 
            var controlDefs = Doyle_Addin.GlobalsHelpers.ThisApplication.CommandManager.ControlDefinitions;
                ...
                case "DarkTheme":
                    {
                        ...
                        {
                            var largeIcon = Doyle_Addin.PictureConverter.SvgResourceToPictureDisp(icon.Icon, iconSizes[1], iconSizes[1], themeSuffix);
                            var smallIcon = Doyle_Addin.PictureConverter.SvgResourceToPictureDisp(icon.Icon, iconSizes[0], iconSizes[0], themeSuffix);
            ...
            uiEvents = Doyle_Addin.GlobalsHelpers.ThisApplication.UserInterfaceManager.UserInterfaceEvents;

            // Ensure the option file exists with default values if it doesn't exist
            if (!File.Exists(Doyle_Addin.Options.UserOptions.OptionsFilePath))
            {
                var defaultOptions = new Doyle_Addin.Options.UserOptions()
                {
            ...
            try
            {
                ...
                if (latestVerObj > localVerObj)
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        Doyle_Addin.GlobalsHelpers.ThisApplication.Quit();
                    }
                    else
                    {
                        File.WriteAllText(@"C:\ProgramData\Autodesk\Inventor Addins\DoyleAddin\pending_update.txt", "update");
        ...
        public void Deactivate()
        {
            ...
            // Release objects.
            uiEvents = null;
            Doyle_Addin.GlobalsHelpers.ThisApplication = (Inventor.Application)null;
        ...
        private void AddToUserInterface()
        {
            ...
            var options = Doyle_Addin.Options.UserOptions.Load();

            // Cache frequently used objects
            var uiManager = Doyle_Addin.GlobalsHelpers.ThisApplication.UserInterfaceManager;
        ...
        {
            new Action(() => Doyle_Addin.DxfUpdate.RunDxfUpdate(Doyle_Addin.GlobalsHelpers.ThisApplication))();
        }

        private static void PrintUpdate_OnExecute(NameValueMap context)
        {
            new Action(() => Doyle_Addin.PrintUpdate.RunPrintUpdate(Doyle_Addin.GlobalsHelpers.ThisApplication))();
        }

        private void OptionsButton_OnExecute(NameValueMap context)
        {
            var optionsForm = new Doyle_Addin.Options.UserOptionsForm();
            var result = optionsForm.ShowDialog(new Globals.WindowWrapper((nint)Doyle_Addin.GlobalsHelpers.ThisApplication.MainFrameHWND));
        ...
        {
            new Action(() => Doyle_Addin.ObsoletePrint.ApplyObsoletePrint(Doyle_Addin.GlobalsHelpers.ThisApplication))();
        }
